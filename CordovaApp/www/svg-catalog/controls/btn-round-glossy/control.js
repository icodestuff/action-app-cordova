(function (ActionAppCore, $) {
    ...
    function setSwitchColor(theValue){
        //console.log("set color",this.colorStop,theValue)
        //this.colorStop.style('color-stop',theValue);
        this.colorBack.style('fill',theValue )
        //var tmpEl = $(this.colorStop[0][0]);
        //tmpEl.attr('style',"stop-color:' + theValue + ';stop-opacity:1")
        //console.log("this.$colorStop",this.$colorStop);
        //this.$colorStop.attr('stop-color','#ff0000');
